...
class VistaPage extends StatefulWidget{
  ...
  static Widget create(BuildContext context) => VistaPage();

  @override
  State<StatefulWidget> createState() => _VistaPage();

}

class _VistaPage extends State<VistaPage>{
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/home_page/ejercicios_page/bg_vista.png'),
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
          child: SizedBox(
            ...
            child: Center(
              child: Padding(
                ...
                child: Column(
                  children: [
                    Text('Identifica 5 cosas a tu al rededor y checkea una casilla cuando encuentres alguna.',
                      textAlign: TextAlign.center,
                      style: TextStyle(fontSize: 18),),
                    SizedBox(height: 20,),
                    checkUno('Primer Objeto','Cama, puerta, silla, etc.'),
                    SizedBox(height: 15),
                    checkDos('Segundo objeto', 'Cama, puerta, silla, etc.'),
                    SizedBox(height: 15),
                    checkTres('Tercer objeto', 'Cama, puerta, silla, etc.'),
                    SizedBox(height: 15),
                    checkCuatro('Cuarto objeto', 'Cama, puerta, silla, etc.'),
                    SizedBox(height: 15),
                    checkCinco('Quinto objeto', 'Cama, puerta, silla, etc.'),
                    SizedBox(height: 80),
                    Row(
                      ...
                      children: [
                        EjercicioAnterior(
                          ...
                          color: Colors.white,
                          onClicked: () => Navigator.pushNamed(context, Routes.respiracion),
                        ),
                        SizedBox(width: 20),
                        SiguienteEjercicio(
        ...
        children: [
          ...
          if(_value4)
            CheckboxListTile(
              title: Text('LISTO!', style: TextStyle(fontSize: 15),),
              subtitle:
                  Text('YA CASI', style: TextStyle(fontSize: 14),),
              autofocus: false,
              activeColor: Colors.green,
              checkColor: Colors.white,
              selected: _value4,
